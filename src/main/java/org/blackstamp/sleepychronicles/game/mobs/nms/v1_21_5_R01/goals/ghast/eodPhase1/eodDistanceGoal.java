...
//
//public class eodDistanceGoal extends Goal {
//    private final emperorOfDarkness entity;
//    private final double minDistance;
//    private final double maxDistance;
//
//    public eodDistanceGoal(emperorOfDarkness entity, double minDistance, double maxDistance) {
//        this.entity = entity;
...
//            entity.getMoveControl().setWantedPosition(retreatPos.x, retreatPos.y, retreatPos.z, 1.0);
//
//        } else if (actualDistance > maxDistance) {
//            entity.getMoveControl().setWantedPosition(target.getX(), target.getY() + 5, target.getZ(), 1.25);
//
//        } else {
...
//                    (entity.getRandom().nextDouble() - 0.5) * 2
//            );
//            entity.getMoveControl().setWantedPosition(hoverPos.x, hoverPos.y, hoverPos.z, 0.3);
//        }
//
//    }
//}
