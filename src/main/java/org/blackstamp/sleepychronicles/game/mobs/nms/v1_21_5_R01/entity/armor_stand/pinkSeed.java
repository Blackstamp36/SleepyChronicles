...
public class pinkSeed extends ArmorStand implements customProjectile {
    ...
    public pinkSeed(EntityType<? extends ArmorStand> entityType, Level level,
    ...
    public void handleProjectileImpact(LivingEntity damagedEntity){
        ...
        bukkitDE.addPotionEffect(new PotionEffect(PotionEffectType.POISON,100,1,false,false));
