package org.blackstamp.sleepychronicles.deprecated.listener.entity.boss.quantumBeast.quantumCore;
...
@EventHandler
    ...
    if (!projectile.getScoreboardTags().contains("quantumBullet")) return;
