package org.blackstamp.sleepychronicles.deprecated.listener.day.day6.endermite;
...
public class onEntitySpawn implements Listener {
    ...
    private void onEntitySpawn(CreatureSpawnEvent e) {
        ...
        netherMite endermite = new netherMite(EntityType.ENDERMITE, nmsLevel);
        nmsLevel.addFreshEntity(endermite);
        endermite.setPos(vec3);
        e.setCancelled(true);
