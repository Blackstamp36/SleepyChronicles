package org.blackstamp.sleepychronicles.api.particle;
...
public class ParticleManager {
    ...
    public void particle(Location loc, Particle particle, @Nullable Object data, int count,
                         double offset, double speed){
        world.spawnParticle(particle, loc, count, offset, offset, offset, speed, data);
    }
    ...
    public void sphere(Location center, Particle particle, double radius, int points,
        ...
        for (int i = 0; i < points; i++){
            ...
            particle(point, particle, data, 1, 0, 0, 0, speed);
        }
    }
    ...
    public void circle(Location center, Particle particle, double radius,
        ...
        for(int i = 0; i < points; i++) {
            ...
            particle(pointLoc, particle, data, 1, 0, 0, 0, speed);
        }
    }
}
